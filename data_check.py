...
def check_adjust(ipckey1,ipckey2):
    ...
    trading_day_map  = pd.Series(index = trading_day_list,data = range(len(trading_day_list)))
    ...
    datas1 = no_adjust_api.fetchDoubleDataList(ind_index,ins_index,0,spots_count_perday * nth_first_roll_day)
    datas2 = adjusted_api.fetchDoubleDataList(ind_index,ins_index,0,spots_count_perday * nth_first_roll_day)
