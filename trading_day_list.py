...
class futureOrder(db.DB_BASE):
    ...
    def set_order_cffex_if(self,method = 'fixed_days',fixed_days = 5):
        ...
        for date in trading_day_list:
            ...
            if method == 'fixed_days':
                ...
                if day > rolling_day[year][month] and day <= exchang_rolling_day[year][month]:
...
if __name__ == '__main__':
    ...
    print order.get_exchange_rollling_day_if(offset = 5)
